...
const BlogGrid = () => {
  ...
  {posts.map((post) => (
    <div key={post.guid} className="p-4 pt-2 text-center w-full box-border border border-gray-300 rounded bg-gray-100 dark:bg-gray-800 dark:border-gray-600 dark:text-white transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg">
      {post.thumbnail && (
        <img src={post.thumbnail} alt={post.title} className="w-full h-48 object-cover mb-2" />
      )}
