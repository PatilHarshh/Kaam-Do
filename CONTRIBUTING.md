...
2. **Clone the Repository:**
   - If you haven't cloned the Kaam-Do repository yet, you can do so by clicking on the "File" menu and selecting "Clone Repository."
   - Choose the Kaam-Do repository from the list of repositories on GitHub and clone it to your local machine.
...
7. **Create a Pull Request:**
  - Go to the GitHub website and navigate to your fork of the Kaam-Do repository.
...
9. **Wait for Review:**
    Your pull request will now be available for review by the project maintainers. They may provide feedback or ask for changes before merging your pull request into the main branch of the Kaam-Do repository.
